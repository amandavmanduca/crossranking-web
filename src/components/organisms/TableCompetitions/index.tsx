        ...
        <> 
            ...
            <div>
                <div style={buttonSection}>
                    {competitionsBySeason?.map((competition: any) => (
                        <button
                            className="buttonTable"
                            style={{
                                background: competition.id === selectedCompetition ? '#e6f5ff' : 'none',
                                opacity: competition.id === selectedCompetition ? '0.9' : ''
                            }}
                            onClick={() => {
                    ...
                    {/* <button
                        ...
                        onClick={() => {
                            setRanking(supergamesRxMasc2019)
                ...
                <div id="TableCompetition" style={pageProps}>
                    {table ? (
                        <table style={TableCompetitionProps}>
                            ...
                            {selectedCompetitionData?.length > 0 ? (
                            selectedCompetitionData?.map((competition: any) => (
                                <tr key={competition.rank}>
                                    ...
                                    <td>
                                        <div style={boxColumn}>
                                            <Image
                                                image={competition.athlete.box.logo}
                                                width='35px'
                                                title={competition.athlete.box.name}
                                            />
                                            <Title title={competition.athlete.box.name} />
                                        </div>
                                    </td>
                                </tr>
                                ))
